...
import com.mongootech.soarlibrary.utils.IOUtils.toByteArray
import com.mongootech.soarlibrary.utils.Loger
import com.mongootech.soarlibrary.utils.Loger.printStackTrace
...
//                    if (!"Content-Type".equalsIgnoreCase(name) && !"Content-Length".equalsIgnoreCase(name)) {
                    if ("AUTHORIZATION".contentEquals(name) || "DEVICENO".contentEquals(name)){//|| "PLATFORM".contentEquals(name) || "VERSION".contentEquals(name) || "DEVICENO".contentEquals(name)) { // || "PLATFORM".equals(name) || "VERSION".equals(name) || "DEVICENO".equals(name)) {
